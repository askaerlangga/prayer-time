...
STRINGS = {
    "id": {
        ...
        "notif_sunrise_title": "Waktu Terbit Matahari",
        "notif_sunrise_body": "Waktu terbit matahari (habisnya waktu Subuh) telah tiba ({}).",
        "sunrise_active": "Waktu Terbit",
    ...
    "en": {
        ...
        "notif_sunrise_title": "Sunrise Time",
        "notif_sunrise_body": "Sunrise time (end of Fajr time) has arrived ({}).",
        "sunrise_active": "Sunrise Time",
